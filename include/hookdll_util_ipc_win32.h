...
typedef struct _PXCH_CHILD_DATA {
	...
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinHttp, Open);
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinHttp, SetOption);
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinINet, InternetOpenA);
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinINet, InternetOpenW);
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinINet, InternetSetOptionA);
	ORIGINAL_FUNC_BACKUP_MEMBER2(WinINet, InternetSetOptionW);
